#!/usr/bin/python3
"""
Contains tests for DBStorage class
"""
...
class TestDBStorageDocs(unittest.TestCase):
    """Tests to check the documentation of DBStorage class,
    actions and style too
    """
    @classmethod
    def setupClass(cls):
        """DBStorage testing setup, Instantiates new DBStorage and
        Fills it with instances of all classes.
        """
